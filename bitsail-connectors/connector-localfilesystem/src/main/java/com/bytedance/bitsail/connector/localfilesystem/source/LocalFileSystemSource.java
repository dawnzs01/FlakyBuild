...
package com.bytedance.bitsail.connector.localfilesystem.source;
...
import com.bytedance.bitsail.connector.localfilesystem.reader.LocalFileSystemSourceReader;

public class LocalFileSystemSource extends SimpleSourceBase<Row> {
  ...
  public SimpleSourceReaderBase<Row> createSimpleReader(BitSailConfiguration readerConfiguration,
    ...
    return new LocalFileSystemSourceReader(readerConfiguration, readerContext);
  }
}